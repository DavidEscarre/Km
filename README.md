...
```
cd existing_repo
git remote add origin https://gitlab.com/david.degonz/proyecte4_km.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/david.degonz/proyecte4_km/-/settings/integrations)
